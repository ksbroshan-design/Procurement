...
/**
 * Normalized side-by-side comparison item for an individual product offer.
 */
public class ProductComparisonItemDto {
    ...
    public ProductComparisonItemDto(UUID offerId,
                                  UUID productId,
                                  String productName,
                                  String brand,
                                  String model,
    ...
    public static class Builder {
        ...
        public ProductComparisonItemDto build() {
            return new ProductComparisonItemDto(offerId, productId, productName, brand, model, category, vendorId,
                    vendorName, source, price, currency, deliveryDays, availability, availableQuantity,
                    warrantyYears, warrantyType, sellerRating, reliabilityScore, returnPolicy, specifications,
                    softPreferencePenalty, eligible);
        }
    }
