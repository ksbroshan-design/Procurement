...
/**
 * Discovery source for MegaRetail Supplies (Wholesale B2B).
 */
@Component
public class MegaRetailProductSource implements ProductDiscoverySource {

    private static final Logger log = LoggerFactory.getLogger(MegaRetailProductSource.class);
    public static final String SOURCE_NAME = "MegaRetail Wholesale B2B";
    public static final String VENDOR_NAME = "MegaRetail Supplies";

    private final ProductRepository productRepository;
    private final VendorRepository vendorRepository;

    public MegaRetailProductSource(ProductRepository productRepository, VendorRepository vendorRepository) {
