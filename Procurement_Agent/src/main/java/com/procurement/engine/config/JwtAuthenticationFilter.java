...
/**
 * JWT Authentication Filter intercepting inbound HTTP requests to validate Bearer tokens.
 */
@Component
        ...
        try {
            ...
            if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                if (jwtService.isTokenValid(jwt, userDetails)) {
                    ...
                    log.debug("Authenticated user [{}] via JWT for request [{}]", userEmail, request.getRequestURI());
                }
            }
        } catch (Exception e) {
            log.warn("JWT authentication failed for request [{}]: {}", request.getRequestURI(), e.getMessage());
            // Clear context if any partial authentication
