...
/**
 * Discovery source for GlobalEquip Solutions (Global Authorized Partner).
 */
@Component
public class GlobalEquipProductSource implements ProductDiscoverySource {

    private static final Logger log = LoggerFactory.getLogger(GlobalEquipProductSource.class);
    public static final String SOURCE_NAME = "GlobalEquip Authorized Partner";
    public static final String VENDOR_NAME = "GlobalEquip Solutions";

    private final ProductRepository productRepository;
    private final VendorRepository vendorRepository;

    public GlobalEquipProductSource(ProductRepository productRepository, VendorRepository vendorRepository) {
